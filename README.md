...
#### 8.1 [Libraries]( "Libraries")
#### 8.2 [Firmware]( "Firmware")
...
During tests of our [self-built DLP 3D printer](https://github.com/fablab-leoben/Fab-dlp) we quickly found out that some kind of post processing of our printed parts was necessary. So the idea of a flexible and hackable UV furnace was born.
